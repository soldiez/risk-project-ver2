...
use App\Filament\Resources\Risk\RiskSeverityResource\Pages;
use App\Filament\Resources\Risk\RiskSeverityResource\RelationManagers;
...
class RiskSeverityResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ManageRiskSeverities::route('/'),
        ];
    }
}
